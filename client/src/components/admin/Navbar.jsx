                            ...
                            <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a className="dropdown-item d-flex align-items-center" href="#">
                                    <div className="dropdown-list-image mr-3">
                                        <img className="rounded-circle" src="admin/img/undraw_profile_1.svg"
                                            alt="..."/>
                                ...
                                <a className="dropdown-item d-flex align-items-center" href="#">
                                    <div className="dropdown-list-image mr-3">
                                        <img className="rounded-circle" src="admin/img/undraw_profile_2.svg"
                                            alt="..."/>
                                ...
                                <a className="dropdown-item d-flex align-items-center" href="#">
                                    <div className="dropdown-list-image mr-3">
                                        <img className="rounded-circle" src="admin/img/undraw_profile_3.svg"
                                            alt="..."/>
